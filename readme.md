...
### DATA EXTRACTION
UFC Data was not accessible so therefore the data was downloaded from http://www.ufcstats.com with [Python](www.python.org) and [BeautifulSoup4](https://beautiful-soup-4.readthedocs.io/en/latest/) using a [Python script](https://github.com/estgarci/UFC-Data-Analysis/blob/main/data/extraction/extract_fighters.py). The dataset contains every fighter in the UFC from the year 1993 to present.
### DATA PREPARATION
